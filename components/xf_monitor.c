...
int xf_list_monitors(clientContext* xfc)
{
	WINPR_UNUSED(xfc);
...
static BOOL xf_is_monitor_id_active(clientContext* xfc, UINT32 id)
{
...
BOOL xf_detect_monitors(clientContext* xfc, UINT32* pMaxWidth, UINT32* pMaxHeight)
{
	BOOL rc = FALSE;
